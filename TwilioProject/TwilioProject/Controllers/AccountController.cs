...
namespace TwilioProject.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            return RedirectToAction("_PartialRegister");
        }
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> _PartialRegister(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, UserRole = "Host" };
